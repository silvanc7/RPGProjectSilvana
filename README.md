...
Once the user gets to this point the user will enter a number(1 or 2) from the menu selection.
...
<img width="622" alt="Screenshot 2024-04-30 at 9 37 12 PM" src="https://github.com/silvanc7/RPGProjectSilvana/assets/156365520/9facfa80-073a-4755-92fd-e13396f059fd">

However, if the user answers correctly, they will continue to the next room to find another riddle.

<img width="637" alt="Screenshot 2024-04-30 at 9 42 13 PM" src="https://github.com/silvanc7/RPGProjectSilvana/assets/156365520/c8eb83fc-16a5-4ae6-83b0-7385e369aa64">

When the user reaches the final room (living room) and answers correctly, they will win the game! And have the choice to play again.
